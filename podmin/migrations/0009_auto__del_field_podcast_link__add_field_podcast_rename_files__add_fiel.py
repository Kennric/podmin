...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Podcast.rename_files'
        db.add_column(u'podmin_podcast', 'rename_files',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Podcast.frequency'
        db.add_column(u'podmin_podcast', 'frequency',
                      self.gf('django.db.models.fields.CharField')(default='never', max_length=10, blank=True),
                      keep_default=False)


        # Changing field 'Podcast.website'
        db.alter_column(u'podmin_podcast', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
        ...
        # Adding field 'Episode.itunes_categories'
        db.add_column(u'podmin_episode', 'itunes_categories',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Episode.priority'
        db.add_column(u'podmin_episode', 'priority',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'Episode.block'
        db.add_column(u'podmin_episode', 'block',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Podcast.rename_files'
        db.delete_column(u'podmin_podcast', 'rename_files')

        # Deleting field 'Podcast.frequency'
        db.delete_column(u'podmin_podcast', 'frequency')


        # Changing field 'Podcast.website'
        db.alter_column(u'podmin_podcast', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
        ...
        # Deleting field 'Episode.itunes_categories'
        db.delete_column(u'podmin_episode', 'itunes_categories')

        # Deleting field 'Episode.priority'
        db.delete_column(u'podmin_episode', 'priority')

        # Deleting field 'Episode.block'
        db.delete_column(u'podmin_episode', 'block')
    ...
    models = {
        ...
        u'podmin.episode': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        u'podmin.podcast': {
