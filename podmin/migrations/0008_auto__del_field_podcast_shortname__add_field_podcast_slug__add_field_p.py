...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'podmin_podcast', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 3, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Episode.filename'
        db.delete_column(u'podmin_episode', 'filename')
        ...
        # Adding field 'Episode.enclosure_file'
        db.add_column(u'podmin_episode', 'enclosure_file',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'podmin_podcast', 'shortname',
                      self.gf('autoslug.fields.AutoSlugField')(default='', max_length=50, unique_with=(), unique=True, populate_from='title'),
                      keep_default=False)
        ...
        # Changing field 'Podcast.website'
        db.alter_column(u'podmin_podcast', 'website', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Podcast.explicit'
        db.alter_column(u'podmin_podcast', 'explicit', self.gf('django.db.models.fields.BooleanField')())
        # Adding field 'Episode.filename'
        db.add_column(u'podmin_episode', 'filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)
        ...
        # Deleting field 'Episode.enclosure_file'
        db.delete_column(u'podmin_episode', 'enclosure_file')
