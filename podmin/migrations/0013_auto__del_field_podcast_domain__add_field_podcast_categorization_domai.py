...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Podcast.categorization_domain'
        db.add_column(u'podmin_podcast', 'categorization_domain',
        ...
        # Adding field 'Episode.categorization_domain'
        db.add_column(u'podmin_episode', 'categorization_domain',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Podcast.categorization_domain'
        db.delete_column(u'podmin_podcast', 'categorization_domain')
        ...
        # Deleting field 'Episode.categorization_domain'
        db.delete_column(u'podmin_episode', 'categorization_domain')
    ...
    models = {
        ...
        u'podmin.episode': {
            ...
            'categorization_domain': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        u'podmin.podcast': {
            ...
            'feedburner_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'itunes_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
