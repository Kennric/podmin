...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.owner'
        db.add_column(u'podmin_podcast', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Podcast.ttl'
        db.alter_column(u'podmin_podcast', 'ttl', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Podcast.updated'
        db.alter_column(u'podmin_podcast', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'Episode.show_notes'
        db.add_column(u'podmin_episode', 'show_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.owner'
        db.delete_column(u'podmin_podcast', 'owner_id')


        # Changing field 'Podcast.ttl'
        db.alter_column(u'podmin_podcast', 'ttl', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Podcast.updated'
        db.alter_column(u'podmin_podcast', 'updated', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Episode.show_notes'
        db.delete_column(u'podmin_episode', 'show_notes')
