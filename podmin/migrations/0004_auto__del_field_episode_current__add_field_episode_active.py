...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Episode.current'
        db.delete_column(u'podmin_episode', 'current')

        # Adding field 'Episode.active'
        db.add_column(u'podmin_episode', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Episode.current'
        db.add_column(u'podmin_episode', 'current',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Episode.active'
        db.delete_column(u'podmin_episode', 'active')
