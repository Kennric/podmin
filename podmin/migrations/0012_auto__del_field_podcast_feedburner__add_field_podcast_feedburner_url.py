...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Podcast.feedburner_url'
        db.add_column(u'podmin_podcast', 'feedburner_url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Podcast.feedburner_url'
        db.delete_column(u'podmin_podcast', 'feedburner_url')
