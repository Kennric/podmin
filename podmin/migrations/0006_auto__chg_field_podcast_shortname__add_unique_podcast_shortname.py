...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'podmin_podcast', 'shortname', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='title', unique_with=()))
        # Adding unique constraint on 'Podcast', fields ['shortname']
        db.create_unique(u'podmin_podcast', ['shortname'])


    def backwards(self, orm):
        # Removing unique constraint on 'Podcast', fields ['shortname']
        db.delete_unique(u'podmin_podcast', ['shortname'])
    ...
    models = {
        ...
        u'podmin.podcast': {
            ...
            'shortname': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'title'", 'unique_with': '()'}),
