...
urlpatterns += patterns(
    ...
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcasts/$',
        'podcasts', name='podcasts_list'),
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcast/(?P<slug>[A-Za-z0-9\-]+)/$',
        'podcast', name='podcast_show'),
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcast/edit/(?P<slug>[A-Za-z0-9\-]+)/$',
        'edit_podcast', name='podcast_edit'),
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcast/new/$',
