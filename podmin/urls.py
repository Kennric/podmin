...
urlpatterns += patterns('podmin.views',    
    ...
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcasts/$', 'podcasts', name='podcasts'),
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcast/(?P<slug>\w+)/$', 'podcast', name='podcast'),
    url(r'^(?P<subsite>[A-Za-z0-9/]*)podcast/edit/(?P<slug>\w+)/$','edit_podcast', name='edit_podcast'),
