...
urlpatterns = patterns('',
    ...
    url(r'^podcast(?:/edit/(?P<pid>\d+))?/$', views.edit_podcast, name='edit_podcast'),
    url(r'^podcast/new/$', views.new_podcast, name='new_podcast'),
    url(r'^episode/(?P<eid>\d+)/$', views.episode, name='episode'),
    url(r'^episode/edit/(?P<eid>\d+)/$', views.edit_episode, name='edit_episode'),
    url(r'^episode/new/(?P<pid>\d+)/$', views.new_episode, name='new_episode'),
    #(?:/(?P<title>[a-zA-Z]+))?/$
